...
# ================================================================PLEASE IGNORE
#    rank_j = np.linalg.matrix_rank(j_mat)
#    print("\n\n")
#    print("rank of J")
#    print(rank_j)
#    
#    
#    j_e = np.hstack( (j_mat, body_v.transpose()) )
##    print("j_e")
##    print(j_e)
#    u, s, v = np.linalg.svd(j_e)
#    rank_j_e = np.sum(s > 1e-10)
##    rank_j_e = np.linalg.matrix_rank( j_e )
#    print("rank of J_e")
#    print(rank_j_e)
...
#    print(body_v[0])
    ...
    #print("unconstr_inds",unconstr_inds)
...
#q = np.array([[0, 0, 1.3, 0,0,0]])
#joint = 4
#
#v = np.array([[-111.60146292,  150.32765422,   50.10921807]])
#omega = np.array([[0., -1., 3]])

#q = np.array([[0, 0, 0, 0,0,0]])
#joint = 4
#
#v = np.array([[1,  np.nan,   np.nan]])
#omega = np.array([[0., np.nan, 3]])
#
