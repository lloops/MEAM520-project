...
class calculateFK():
    ...
    def forward(self, q):
        ...
        p_4 = np.array([0, 0, 34, 1])

        # compute the transformation matrix of the gripper
        for i in range(5):
    ...
    def getA(self, a, alp, d, theta):
        ...
        A = np.array([
                        [cos_theta, -sin_theta * cos_alp, sin_theta * sin_alp, a*cos_theta],
                        [sin_theta, cos_theta * cos_alp, -cos_theta * sin_alp, a*sin_theta],
                        [0, sin_alp, cos_alp, d],
                        [0, 0, 0, 1]])
